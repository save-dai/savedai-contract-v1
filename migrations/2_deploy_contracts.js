...
module.exports = function (deployer) {
  deployer.then(async () => {
    ...
    if ((await web3.eth.net.getId()) == 4) {
      ...
      // no comp address - https://compound.finance/docs
      ...
      compAddr = "0x61460874a7196d6a22d1ee4922473664b3e95270";
      ...
      compAddr = "0xc00e94cb662c3520282e6f5717214004a7f26888";
    } else {
      // local ganache
      uniswapFactoryAddr = "0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95";
      cDaiAddr = "0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643";
    ...
    const saveDAI = await deployer.deploy(
      SaveDAI, uniswapFactoryAddr, cDaiAddr, ocDaiAddr, daiAddr, compAddr, saveTokenFarmerAddress
    );
